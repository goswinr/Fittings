...
module TextBlockAutoOpen = 
    ...
    type internal TextEditorWrapper(textContainer : obj, uiScope : FrameworkElement, isUndoEnabled : bool) = 
        ...
        static let textEditorType = Type.GetType ("System.Windows.Documents.TextEditor, PresentationFramework, Version=4.0.0.0, Culture=neutral, PublicKeyToken=31bf3856ad364e35")
        ...
        static let textContainerType = Type.GetType ("System.Windows.Documents.ITextContainer, PresentationFramework, Version=4.0.0.0, Culture=neutral, PublicKeyToken=31bf3856ad364e35")
    ...
    type TextBlockSelectable() as this= 
        ...
        static do
            UIElement.FocusableProperty.OverrideMetadata(typeof<TextBlockSelectable>, new FrameworkPropertyMetadata(true))
